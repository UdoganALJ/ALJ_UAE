report 63201 ALJRep_SalesOrdPackingList_UAE
{
    Caption = 'ALJ Sales Order Packing List';
    DefaultRenderingLayout = "ALJSalesOrderPackingList.rdlc";
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Document Type", "No.") where("Document Type" = const(Order), "DBV Vehicle Invoice" = const(false));
            ...
            column(gCountryOfOriginLbl; gCountryOfOriginLbl)
            {

            }
            column(gItemLbl; gItemLbl)
            {

            }
            column(gNetWeightLbl; gNetWeightLbl)
            {

            }
            column(gPartNumberLbl; gPartNumberLbl)
            {

            }
            column(gQtyLbl; gQtyLbl)
            {

            }
            column(gDescriptionCaptionLbl; gDescriptionCaptionLbl)
            {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(gALJCountryOfOrigin; gALJCountryOfOrigin)
                {

                }
                column(gALJNetWeight; gALJNetWeight)
                {

                }
                column(gLineRecurrence; gLineRecurrence)
                {
                ...
                begin
                    ...
                    if Type = Type::Item then begin //ALJ Part
                        gItem.Get("No.");
                        gALJCountryOfOrigin := gItem."Country/Region of Origin Code";
                        gALJNetWeight := gItem."Net Weight";
                    end
                    else begin
                        gALJCountryOfOrigin := '';
                        gALJNetWeight := 0;
    ...
    rendering
    {
        layout("ALJSalesOrderPackingList.rdlc")
        {
            Type = RDLC;
            LayoutFile = './.vscode/ReportLayouts/SalesOrder/ALJRepLay_SalesOrderPackingList_UAE.rdl';
            Caption = 'ALJ Sales Order Packing List';
            Summary = 'ALJ Sales Order Packing List. A list of items with packing details, to be generated from a sales order.';
        }
    ...
    var
        ...
        gALJCountryOfOrigin: Code[20];
        gALJNetWeight: Decimal;
        gLineRecurrence: Integer;
        gItem: Record Item;
    ...
    protected var
        ...
        SalesConfirmationLbl: Label 'DELIVERY NOTE / PACKING LIST';
        SalesInvLineDiscLbl: Label 'Discount %';
        SalespersonLbl: Label 'Sales person';
        ShptMethodDescLbl: Label 'Shipment Method';
        gItemLbl: Label 'Item';
        gCountryOfOriginLbl: Label 'Country Of Origin';
        gPartNumberLbl: Label 'Part Number';
        gQtyLbl: Label 'Qty';
        gNetWeightLbl: Label 'N.W(KGS)';
        gDescriptionCaptionLbl: Label 'Full Description of Goods';
